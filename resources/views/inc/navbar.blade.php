    ...
    <div class="iq-sidebar  sidebar-default ">
        <div class="iq-sidebar-logo d-flex align-items-center justify-content-between">
            <a href="{{ route('home') }}" class="header-logo">
                <img src="{{ asset('assets/images/layouts/02.jpg') }}" class="img-fluid rounded-normal light-logo" alt="logo">
                        ...
                        <ul id="category" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                            <li class="">
                                <a href="{{ route('category.index') }}">
                                    <i class="fa fa-minus"></i><span>Manage Category</span>
                                </a>
                            </li>
                        </ul>
                    </li>
            ...
            <nav class="navbar navbar-expand-lg navbar-light p-0">
                <div class="iq-navbar-logo d-flex align-items-center justify-content-between">
                    ...
                    <a href="home" class="header-logo">
                        <img src="{{asset('assets/images/layouts/02.jpg')}}" class="img-fluid rounded-normal" alt="logo">
                        ...
                        <ul class="navbar-nav navbar-list align-items-center">
                            ...
                            <li class="nav-item nav-icon dropdown caption-content mr-auto">
                                <a href="#" class="search-toggle dropdown-toggle" id="dropdownMenuButton4"
                                    ...
                                    <img src="{{ asset('/storage/users/' . Auth::user()->user_img) }}" class="img-fluid rounded "
                                        alt="user">
                                </a>
                                <div class="iq-sub-dropdown dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    <div class="card shadow-none m-0">
                                        <div class="card-body p-0 text-center">
                                            <div class="media-body profile-detail text-center">
                                                <img src="{{ asset('assets/images/layouts/04.jpg') }}"
                                                    alt="profile-bg" class="rounded-top img-fluid mb-4">
                                                <img src="{{ asset('/storage/users/' . Auth::user()->user_img) }}" alt="profile-img"
